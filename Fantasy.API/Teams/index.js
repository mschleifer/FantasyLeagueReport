module.exports = async function (context, req) {
    context.log('JavaScript HTTP trigger function processed a request for Teams');
    ...
    try {
        const apiCallResult = await myClient.getTeamsAtWeek({ seasonId: SEASON_ID, scoringPeriodId: WEEK_ID });
